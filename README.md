...
Note that this raytracer is CPU based, for simplicity. I plan to port it to the GPU in the future, which is the ideal hardware for an application like this.
